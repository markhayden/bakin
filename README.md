...
It gives teams a self-hosted dashboard, backend, CLI, and plugin system for managing tasks, schedules, assets, brands, workflows, memory, models, spend limits, health checks, automation, and direct agent chat.
