...
INSERT OR IGNORE INTO flow_runs (flow_id, owner_key, controller_id, status, goal, blocked_task_id, blocked_summary, state_json, created_at, updated_at) VALUES
  ('task-bk-001', 'bakin:task:task-bk-001', 'bakin/tasks', 'waiting', 'Publish blog post to website', 'blocked', 'Waiting for blog post draft (task-td-001)', '{"title":"Publish blog post to website","agent":"patch","createdBy":"main-operator","dependsOn":"task-td-001","order":0}', 1743595200000, 1743681600000);
...
INSERT OR IGNORE INTO flow_runs (flow_id, owner_key, controller_id, status, goal, state_json, created_at, updated_at, ended_at) VALUES
  ('task-dn-001', 'bakin:task:task-dn-001', 'bakin/tasks', 'succeeded', 'Create thumbnail for YouTube video', '{"title":"Create thumbnail for YouTube video","agent":"pixel","date":"2026-04-03","createdBy":"main-operator","order":0,"log":[{"timestamp":"2026-04-03T11:00:00Z","author":"pixel","message":"Thumbnail generated at 1280x720"},{"timestamp":"2026-04-03T11:30:00Z","author":"main-operator","message":"Approved — looks great"}]}', 1743505200000, 1743678000000, 1743678000000),
  ('task-dn-002', 'bakin:task:task-dn-002', 'bakin/tasks', 'succeeded', 'Update team availability for April', '{"title":"Update team availability for April","agent":"coach","date":"2026-04-02","createdBy":"main-operator","order":1}', 1743418800000, 1743591600000, 1743591600000),
  ('task-dn-003', 'bakin:task:task-dn-003', 'bakin/tasks', 'succeeded', 'Post morning motivation to Discord', '{"title":"Post morning motivation to Discord","agent":"trainer","date":"2026-04-04","createdBy":"main-operator","scheduleJobId":"daily-brief","order":2}', 1743678000000, 1743764400000, 1743764400000);

-- archived (status=succeeded, archived=true)
INSERT OR IGNORE INTO flow_runs (flow_id, owner_key, controller_id, status, goal, state_json, created_at, updated_at, ended_at) VALUES
  ('task-cf-001', 'bakin:task:task-cf-001', 'bakin/tasks', 'succeeded', 'Set up analytics dashboard', '{"title":"Set up analytics dashboard","agent":"rolo","date":"2026-03-28","archived":true,"createdBy":"main-operator","order":0,"log":[{"timestamp":"2026-03-28T16:00:00Z","author":"rolo","message":"Dashboard live at /analytics"},{"timestamp":"2026-03-29T09:00:00Z","author":"main-operator","message":"Confirmed — data looks accurate"}]}', 1743159600000, 1743332400000, 1743332400000);
