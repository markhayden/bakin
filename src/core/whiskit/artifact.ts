/**
 * Whiskit artifact assembly + verification.
 *
 * A published artifact is a tarball of a plugin's built output:
 *   bakin-plugin.json, dist/, optional node_modules/, .whiskit/build.json
 ...
 *
 * Part of the Whiskit artifact format (Phase 3).
 */
...
/** Top-level entries permitted inside a Whiskit plugin artifact. */
const ALLOWED_TOP_LEVEL = new Set(['bakin-plugin.json', 'dist', 'node_modules', '.whiskit'])
