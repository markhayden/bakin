...
export const CLI_COMMANDS = [
  ...
  cli({
    ...
    description: 'Runs Bakin diagnostics for local dependencies, server state, agents, plugin assets, gateway behavior, and recoverable issues.',
    examples: [{ title: 'Run diagnostics', code: 'bakin doctor', test: 'illustrative', reason: 'Depends on local Bakin/OpenClaw state.' }],
  }),
  ...
  cli({ name: 'agents list', usage: 'bakin agents list [--packages]', group: 'Agents and packages', summary: 'List agents.', description: 'Lists runtime agents, or package state when `--packages` is set.', examples: [{ title: 'List agents', code: 'bakin agents list', test: 'illustrative', reason: 'Depends on OpenClaw/Bakin state.' }] }),
  cli({ name: 'agents status', usage: 'bakin agents status <id>', group: 'Agents and packages', summary: 'Get agent status.', description: 'Fetches detailed status for an agent.', examples: [{ title: 'Agent status', code: 'bakin agents status patch', test: 'illustrative', reason: 'Depends on OpenClaw/Bakin state.' }] }),
  ...
  cli({ name: 'agents send', usage: 'bakin agents send <id> <message>', group: 'Agents and packages', summary: 'Send a message to an agent.', description: 'Sends a message through the running server to an agent.', examples: [{ title: 'Message an agent', code: 'bakin agents send patch "Check the build"', test: 'illustrative', reason: 'Requires a running agent gateway.' }] }),
  cli({ name: 'agents install', usage: 'bakin agents install <path|github:user/repo[@ref]> [--adopt] [--install-as <id>] [--replace]', group: 'Agents and packages', summary: 'Install an agent package.', description: 'Installs or adopts an agent package into Bakin/OpenClaw-managed agent state.', examples: [{ title: 'Install local package', code: 'bakin agents install ./agent-package --install-as patch', test: 'illustrative', reason: 'Mutates local agent package state.' }] }),
  cli({ name: 'agents remove', usage: 'bakin agents remove <agent-id> [--keep-blocks] [--delete-agent] [--force]', group: 'Agents and packages', summary: 'Remove an agent package.', description: 'Removes an installed agent package and optionally deletes the OpenClaw agent.', examples: [{ title: 'Remove package', code: 'bakin agents remove patch --keep-blocks', test: 'illustrative', reason: 'Mutates local agent package state.' }] }),
  ...
  cli({ name: 'plugins install', usage: 'bakin plugins install <path|github:user/repo[#subpath]> [--yes]', group: 'Plugins', summary: 'Install a plugin.', description: 'Installs a plugin from a local path or GitHub source. Append #subpath to install from a monorepo directory. --yes skips the consent prompt.', examples: [{ title: 'Install local plugin', code: 'bakin plugins install ./my-plugin', test: 'illustrative', reason: 'Mutates local plugin state.' }] }),
  ...
  cli({ name: 'setup antfly', usage: 'bakin setup antfly', group: 'Setup and config', stability: 'deprecated', summary: 'Deprecated Antfly setup alias.', description: 'Deprecated alias for `bakin install antfly`.', examples: [{ title: 'Deprecated alias', code: 'bakin setup antfly', test: 'illustrative', reason: 'Delegates to install and may install dependencies.' }] }),
  cli({ name: 'setup mcporter', usage: 'bakin setup mcporter', group: 'Setup and config', stability: 'deprecated', summary: 'Deprecated mcporter setup alias.', description: 'Deprecated alias for `bakin install mcporter`.', examples: [{ title: 'Deprecated alias', code: 'bakin setup mcporter', test: 'illustrative', reason: 'Delegates to install and may install dependencies.' }] }),
  ...
  cli({ name: 'init', usage: 'bakin init', group: 'Setup and config', stability: 'deprecated', summary: 'Deprecated initialization alias.', description: 'Deprecated alias for `bakin mkdir`.', examples: [{ title: 'Deprecated init', code: 'bakin init', test: 'illustrative', reason: 'Writes local home directory state.' }] }),
  cli({ name: 'check', usage: 'bakin check <openclaw|llm|channels|plugin-assets|agent-assets|all>', group: 'Setup and config', summary: 'Run onboarding checks.', description: 'Runs one or all first-run readiness checks.', examples: [{ title: 'Run all checks', code: 'bakin check all', test: 'illustrative', reason: 'Depends on local environment.' }] }),
  cli({ name: 'install', usage: 'bakin install <antfly|models|mcporter|plugin-assets|agent-assets>', group: 'Setup and config', summary: 'Install onboarding components.', description: 'Installs Bakin dependencies or plugin/agent assets.', examples: [{ title: 'Install mcporter', code: 'bakin install mcporter', test: 'illustrative', reason: 'Downloads or mutates local dependencies.' }] }),
  ...
  cli({ name: 'schedule', usage: 'bakin schedule [list|add|pause|resume|remove|run|runs] ...', group: 'Schedule and messaging', summary: 'Manage scheduled jobs.', description: 'Lists, creates, pauses, resumes, removes, triggers, or inspects scheduled jobs.', examples: [{ title: 'List scheduled jobs', code: 'bakin schedule list', test: 'illustrative', reason: 'Requires running server data.' }] }),
  cli({ name: 'messaging', usage: 'bakin messaging <list|get|create|update|delete|approve|reject|sessions|session|session-create|session-update|session-delete|message|confirm|proposal> ...', group: 'Schedule and messaging', summary: 'Manage messaging items and planning sessions.', description: 'Works with content calendar items, planning sessions, proposals, and approvals.', examples: [{ title: 'List messaging items', code: 'bakin messaging list --status=draft', test: 'illustrative', reason: 'Requires running server data.' }] }),
  ...
  cli({ name: 'reindex', usage: 'bakin reindex [--table=<name>] [--rebuild]', group: 'Assets and search', summary: 'Reindex content.', description: 'Triggers content indexing to Antfly.', examples: [{ title: 'Reindex tasks', code: 'bakin reindex --table=tasks', test: 'illustrative', reason: 'Requires local Antfly/server state.' }] }),
  ...
  cli({ name: 'search', usage: 'bakin search <query> [--table=<name>] [--agent=<id>] [--limit=<n>] [--facets=<list>]', group: 'Assets and search', summary: 'Search indexed content.', description: 'Searches Antfly-indexed Bakin content.', examples: [{ title: 'Search tasks', code: 'bakin search "blocked task" --table=tasks --limit=5', test: 'illustrative', reason: 'Requires indexed local content.' }] }),
