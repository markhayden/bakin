...
export const CLI_COMMANDS = [
  ...
  cli({ name: 'plugins list', usage: 'bakin plugins list', group: 'Plugins', summary: 'List installed plugins.', description: 'Lists installed plugins and versions.', examples: [{ title: 'List plugins', code: 'bakin plugins list', test: 'illustrative', reason: 'Requires local server/plugin state.' }] }),
  cli({ name: 'plugins install', usage: 'bakin plugins install <path|github:user/repo>', group: 'Plugins', summary: 'Install a plugin.', description: 'Installs a plugin from a local path or GitHub source.', examples: [{ title: 'Install local plugin', code: 'bakin plugins install ./my-plugin', test: 'illustrative', reason: 'Mutates local plugin state.' }] }),
