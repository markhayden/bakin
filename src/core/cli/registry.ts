...
export const CLI_COMMANDS = [
  ...
  cli({ name: 'plugins install', usage: 'bakin plugins install <path|github:user/repo> [--yes]', group: 'Plugins', summary: 'Install a plugin.', description: 'Installs a plugin from a local path or GitHub source. --yes skips the consent prompt.', examples: [{ title: 'Install local plugin', code: 'bakin plugins install ./my-plugin', test: 'illustrative', reason: 'Mutates local plugin state.' }] }),
