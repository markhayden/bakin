...
export const AGENT_PROFILES: AgentProfile[] = [
  {
    ...
    headshot: '/api/agents/avatar?id=roscoe',
  ...
  },
  {
    ...
    headshot: '/api/agents/avatar?id=basil',
    model: 'claude-sonnet-4-6',
...

  {
    ...
    headshot: '/api/agents/avatar?id=scout',
    model: 'claude-sonnet-4-6',
  ...
  },
  {
    ...
    headshot: '/api/agents/avatar?id=nemo',
    model: 'claude-sonnet-4-6',
  ...
  },
  {
    ...
    headshot: '/api/agents/avatar?id=zen',
    model: 'claude-sonnet-4-6',
