...
export const AGENT_PROFILES: AgentProfile[] = [
  ...
  },
  {
    ...
    model: 'claude-sonnet-4-6',
    definition: 'Pixel generates images for the content pipeline — food photography, character portraits, branded graphics, and social media visuals. She works from briefs provided by Basil or Roscoe.',
    shouldDo: [
