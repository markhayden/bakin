...
export const AGENT_PROFILES: AgentProfile[] = [
...

  {
    ...
    emoji: '🌲',
    name: 'Explorer',
    role: 'Outdoor Enthusiast · SampleBrand Affiliate',
    title: 'Content Creator',
    ...
    shouldNotDo: [
      'Write fitness or nutrition content — that\'s Trainer or Chef',
  ...
  },
  {
    ...
    emoji: '🏊',
    name: 'Trainer',
    role: 'Fitness Coach · SampleBrand Affiliate',
    title: 'Content Creator',
    ...
    shouldNotDo: [
      ...
      'Write nutrition or outdoor content — that\'s Chef or Explorer',
    ],
    examples: [
  ...
  },
  {
    ...
    emoji: '🌿',
    name: 'Coach',
    role: 'Life Coach · SampleBrand Affiliate',
    title: 'Content Creator',
