...
- **IDs:** M-1 through M-6
- **Files:** `~/.claude/projects/-Users-roscoe-go-src-github-com-madeinwyo-bakin/memory/*.md`
- **Pre-flight:** none
...
- **Verification:**
  ```bash
  grep -rilI beacon ~/.claude/projects/-Users-roscoe-go-src-github-com-madeinwyo-bakin/memory/    # empty
  test ! -f ~/.claude/projects/-Users-roscoe-go-src-github-com-madeinwyo-bakin/memory/project_beacon_skill_rename.md
  ```
...
# §4 item 13
grep -rilI beacon ~/.claude/projects/-Users-roscoe-go-src-github-com-madeinwyo-bakin/memory/
test ! -f ~/.claude/projects/-Users-roscoe-go-src-github-com-madeinwyo-bakin/memory/project_beacon_skill_rename.md
