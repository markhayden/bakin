...
### Who this is for
- **Primary:** Main Operator (main orchestrator agent) — needs a discoverable tool to stand up new agents end-to-end.
...
### Current state
- `main.subagents.allowAgents`: `["pixel", "patch", "chef", "rolo", "explorer", "trainer", "coach"]`
- `chef.subagents.allowAgents`: `["pixel", "rolo"]`
...
- `dispatchable: ["chef", "explorer"]` — add to those specific agents' lists, plus always `main`.
