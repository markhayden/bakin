...
| `plugin-slot:workflows:page:/workflows` | Unified table — local review | User approved one DataTable with Source classification/filter, five sortable headings, unified pagination and search. Preserves summaries/assignments; visual checkpoint remains open. |
