...
**Status:** Phase 1 SHIPPED — PR #829 merged 2026-09-18. Phase 2 in progress: PR 1 (team) SHIPPED #830; PR 2 (tasks) SHIPPED #839; PR 3 (workflows) on `feat/workflows-url-state` (`tasks/workflows-url-state/plan.md`).
**Date:** 2026-09-18
