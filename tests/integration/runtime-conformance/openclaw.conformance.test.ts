...
runRuntimeConformanceSuite('openclaw (imitation crab)', () => target, { sessionsPin: SESSIONS_PIN_ENABLED, cron: 'present', contextStats: 'present', credentials: 'present', restartAdvice: 'present', resolveId: 'absent' })
