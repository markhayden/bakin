# Whiskit source-only plugin fixtures

Source-only plugin trees (no committed `dist/`) used by the Whiskit build,
...
See `.claude/specs/whiskit-plugin-builder-plan.md` (Phase 0).
