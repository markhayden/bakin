...
const PRIMITIVES_BASELINES = [
  ...
  { url: '/iframe.html?id=components-primitives-card--title-as-heading&viewMode=story', png: 'primitives-card-title-as-heading.png', text: 'A card that is a section of the page' },
  ...
  { url: '/iframe.html?id=recipes-filterable-table-page--filterable-table&viewMode=story', png: 'recipes-filterable-table.png', text: 'Showing 1–8 of 12' },
  { url: '/iframe.html?id=recipes-form-in-a-drawer--edit-flow&viewMode=story', png: 'recipes-form-in-drawer.png', text: 'Agent profile saved' },
  ...
  { url: '/iframe.html?id=components-layout-guidecard--opening-a-section&viewMode=story', png: 'layout-guide-card.png', text: 'Say what a surface is for before showing its controls' },
  ...
  { url: '/iframe.html?id=components-lists-datatable--selected-row&viewMode=story', png: 'lists-data-table-selected-row.png', text: 'One row stands out' },
