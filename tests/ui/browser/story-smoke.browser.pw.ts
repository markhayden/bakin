...
const detailPageStory = '/iframe.html?id=recipes-list-and-detail-pages--detail&viewMode=story'
const detailUnavailableStory = '/iframe.html?id=recipes-list-and-detail-pages--detail-unavailable&viewMode=story'
const settingsPageStory = '/iframe.html?id=recipes-settings-and-dashboard-pages--settings-categories&viewMode=story'
const settingsUnavailableStory = '/iframe.html?id=recipes-settings-and-dashboard-pages--settings-unavailable&viewMode=story'
const dashboardPageStory = '/iframe.html?id=recipes-settings-and-dashboard-pages--dashboard-overview&viewMode=story'
const dashboardUnavailableStory = '/iframe.html?id=recipes-settings-and-dashboard-pages--dashboard-unavailable&viewMode=story'
const conversationPageStory = '/iframe.html?id=recipes-conversation-and-inspector-pages--conversation&viewMode=story'
const conversationUnavailableStory = '/iframe.html?id=recipes-conversation-and-inspector-pages--conversation-unavailable&viewMode=story'
const inspectorStory = '/iframe.html?id=recipes-conversation-and-inspector-pages--inspector&viewMode=story'
const inspectorUnavailableStory = '/iframe.html?id=recipes-conversation-and-inspector-pages--inspector-unavailable&viewMode=story'
const verticalWorkflowStory = '/iframe.html?id=recipes-workflow-and-action-pages--vertical-workflow&viewMode=story'
