...
describe('Channel support — routes', () => {
  ...
  it('filters items by channel query param (channels array)', async () => {
    ...
    await callRoute(postRoute, plugin.ctx, {
      body: { title: 'General only', agent: 'chef', scheduledAt: '2026-04-14T10:00:00Z', channels: ['general'] },
    })
    await callRoute(postRoute, plugin.ctx, {
      body: { title: 'Announcements only', agent: 'chef', scheduledAt: '2026-04-14T11:00:00Z', channels: ['announcements'] },
    })
    await callRoute(postRoute, plugin.ctx, {
      body: { title: 'Both', agent: 'chef', scheduledAt: '2026-04-14T12:00:00Z', channels: ['general', 'announcements'] },
    })
    ...
    writeFileSync(join(testDir, 'messaging.json'), JSON.stringify([
      {
        ...
        scheduledAt: '2026-04-15T10:00:00Z', agent: 'chef',
      ...
      },
      {
        ...
        scheduledAt: '2026-04-15T11:00:00Z', agent: 'chef',
