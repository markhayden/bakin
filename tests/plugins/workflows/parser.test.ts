  ...
  describe('validateDefinition', () => {
    ...
    it('rejects gate approval jumps that do not point to the next step', () => {
      const def: WorkflowDefinition = {
        ...
        steps: [
          ...
          { id: 'revise', type: 'agent', label: 'Revise', agent: 'basil' },
          { id: 'publish', type: 'output', label: 'Publish', agent: 'basil' },
        ],
      }
    ...
    it('requires plugin-shipped definitions to use symbolic agents', () => {
      const def: WorkflowDefinition = {
        ...
        version: 1,
        steps: [{ id: 'write', type: 'agent', label: 'Write', agent: 'basil' }],
      }
    ...
    it('validates user literal agents against the runtime roster when supplied', () => {
      ...
      const errors = validateDefinition(def, { source: 'user', runtimeAgents: ['nemo'] })
