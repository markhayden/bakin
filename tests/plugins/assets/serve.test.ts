...
const manifest: AssetManifest = {
  ...
  versions: [
    { version: 1, file: 'v1.png', thumb: null, mimeType: 'image/png', size: 3, width: 4, height: 4, created: 'c', op: 'generate', parentVersion: null, tool: 't', prompt: 'p1', promptHash: 'h1', generation: null },
    { version: 2, file: 'v2.png', thumb: 'v2.thumb.jpg', mimeType: 'image/png', size: 3, width: 4, height: 4, created: 'c', op: 'edit', parentVersion: 1, tool: 't', prompt: 'p2', promptHash: 'h2', generation: null },
  ],
  exports: [
