...
// ---------------------------------------------------------------------------
const KNOWN_AGENTS = ['roscoe', 'patch', 'pixel', 'rolo', 'basil', 'scout', 'nemo', 'zen']
...
2. If this content needs an image or video:
   ...
   b. IMPORTANT: Tell Pixel/Rolo to save the image to content/assets/ with a descriptive filename like content/assets/{agent}-{type}.png (e.g. content/assets/nemo-workout.png)
