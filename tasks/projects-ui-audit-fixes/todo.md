...
- [x] T02: Reproduce detail diagnostics and risky write behavior
...
- [x] T16: Implement project draft state independently of rendering
- [x] T17: Connect the staged project form
- [x] T18: Compose explicit field conflict resolution
- [x] T19: Own independent checklist mutations and drafts
- [x] T20: Make checklist editing and progress accessible
- [x] T21: Coordinate all drafts with the shared exit guard
- [x] T22: Compact optional mobile brainstorm without losing state
