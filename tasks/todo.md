...
- [ ] T0: branch, baseline, consumer recheck; commit C0.
- [ ] T1: runtime helper removal guards fail for the expected reason.
- [ ] T2: facade removal; live behavior remains green.
- [ ] T3: package JS/declarations and docs agree.
- [ ] Checkpoint A passes; commit C1.
