...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      defaultLocale: 'root',
      editLink: {
        baseUrl: 'https://github.com/markhayden/bakin/edit/main/apps/docs/src/content/docs/',
      },
      lastUpdated: true,
      social: [
        {
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Tasks', slug: 'run/tasks' },
            { label: 'Workflows', slug: 'run/workflows' },
            { label: 'Projects', slug: 'run/projects' },
            { label: 'Assets', slug: 'run/assets' },
            { label: 'Schedule', slug: 'run/schedule' },
            { label: 'Messaging', slug: 'run/messaging' },
            { label: 'Memory', slug: 'run/memory' },
            { label: 'Models', slug: 'run/models' },
            { label: 'Team', slug: 'run/team' },
            { label: 'Health', slug: 'run/health' },
          ],
        },
        {
          label: 'Extend Bakin',
