...
| --- | --- | --- |
| CLI commands | `src/core/cli/registry.ts` | Active: 58 commands, 58 examples |
...
| Settings | `packages/core/src/settings.ts` | Active: 52 flattened settings |
...
| Tested snippets | `apps/docs/snippets` | Active: 4 required fixtures |
| LLM docs | `apps/docs/public/llms*` | Active: 11 public bundles |
