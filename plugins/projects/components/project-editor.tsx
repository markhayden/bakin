  ...
  if (editing) {
    return (
      <textarea
        ...
        className="w-full min-h-[320px] text-sm font-mono leading-relaxed bg-zinc-900/40 border border-[rgba(255,255,255,0.06)] rounded-lg p-4 text-foreground placeholder:text-zinc-600 focus:outline-none focus:border-[#5e6ad2]/40 resize-y transition-colors"
