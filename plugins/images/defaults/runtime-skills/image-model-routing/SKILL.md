...
- `provider`: optional forced provider (`auto`, `openai`, `google`, or a configured runtime provider id)
...
5. Prefer runtime routes when configured. With OpenClaw, this includes Codex OAuth-backed OpenAI routes and any image provider OpenClaw reports as configured.
