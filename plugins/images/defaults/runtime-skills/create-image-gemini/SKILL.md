...
4. Call `bakin_exec_images_generate` with `provider: "google"`, the returned model, surface, quality, task id, prompt, and prompt packet. If invoking through mcporter, use `--timeout 600000`.
