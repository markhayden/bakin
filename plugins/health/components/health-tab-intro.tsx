  ...
  return (
    ...
    >
      <div className="min-w-0 flex-1 basis-80">
        ...
        <p
          className="max-w-3xl text-xs leading-relaxed text-muted-foreground/80"
      ...
      {actions && (
        <div className="flex max-w-full flex-wrap items-center gap-2" data-slot="health-tab-intro-actions">
          {actions}
        </div>
      )}
    </header>
