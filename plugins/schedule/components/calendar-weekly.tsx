...
const AGENT_STYLES: Record<string, {
  ...
  scout:   { border: 'border-emerald-500/30', bg: 'bg-emerald-500/[0.06]', glow: 'rgba(52,211,153,0.10)',  accent: 'text-emerald-400', dot: 'bg-emerald-400', gradient: 'linear-gradient(135deg, rgba(52,211,153,0.4), rgba(52,211,153,0.08))' },
  nemo:    { border: 'border-cyan-500/30',    bg: 'bg-cyan-500/[0.06]',    glow: 'rgba(34,211,238,0.10)',  accent: 'text-cyan-400',    dot: 'bg-cyan-400',    gradient: 'linear-gradient(135deg, rgba(34,211,238,0.4), rgba(34,211,238,0.08))' },
