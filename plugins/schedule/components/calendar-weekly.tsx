...
export const AGENT_STYLES: Record<string, {
  ...
  main-operator:  { border: 'border-blue-500/30',    bg: 'bg-blue-500/[0.06]',    glow: 'rgba(96,165,250,0.10)',  accent: 'text-blue-400',    dot: 'bg-blue-400',    gradient: 'linear-gradient(135deg, rgba(96,165,250,0.4), rgba(96,165,250,0.08))' },
