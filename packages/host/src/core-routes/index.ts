...
const dispatchAndPackagesRoutes = [
  ...
  defineCoreRoute({ path: '/api/agent-packages', method: 'GET', summary: 'List agent packages', responses: { 200: passthrough }, handler: stub }),
  ...
  defineCoreRoute({ path: '/api/agent-packages/:agentId/update', method: 'POST', summary: 'Update agent package', params: z.object({ agentId: z.string() }), body: z.object({ refreshTemplate: z.boolean().optional() }).passthrough(), responses: { 200: passthrough, 404: errorResponse, 500: errorResponse }, handler: stub }),
  defineCoreRoute({ path: '/api/agent-packages/:agentId/knowledge', method: 'GET', summary: 'List agent package knowledge', params: z.object({ agentId: z.string() }), responses: { 200: passthrough, 404: errorResponse }, handler: stub }),
  defineCoreRoute({ path: '/api/agent-packages/:agentId/knowledge/:lessonId', method: 'POST', summary: 'Toggle agent package knowledge', params: z.object({ agentId: z.string(), lessonId: z.string() }), body: z.object({ enabled: z.boolean() }), responses: { 200: okResponse, 404: errorResponse }, handler: stub }),
  ...
  defineCoreRoute({ path: '/api/packages/:packageId/update', method: 'POST', summary: 'Update reusable package', params: z.object({ packageId: z.string() }), body: { contentType: 'none' }, responses: { 200: passthrough, 404: errorResponse }, handler: stub }),
  defineCoreRoute({ path: '/api/curated', method: 'GET', summary: 'List curated installable packages', responses: { 200: passthrough }, handler: stub }),
  defineCoreRoute({ path: '/api/plugin-settings/schemas', method: 'GET', summary: 'List plugin settings schemas', responses: { 200: passthrough }, handler: stub }),
  defineCoreRoute({ path: '/api/plugin-settings/:pluginId', method: 'GET', summary: 'Get plugin settings', params: z.object({ pluginId: z.string() }), responses: { 200: passthrough, 404: errorResponse }, handler: stub }),
...
const pluginsAndMiscRoutes = [
  ...
  defineCoreRoute({ path: '/api/activity', method: 'GET', summary: 'List activity feed events', description: 'Returns unified activity data from audit events and task logs.', responses: { 200: passthrough }, handler: stub }),
