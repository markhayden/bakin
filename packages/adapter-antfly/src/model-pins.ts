/**
 * Pinned model distributions for the pinned engine (see pin.ts, 0.2.2 —
 * re-verified 2026-09-18: the same distributions load and embed on the
 * 0.2.2 Metal runtime, hashes unchanged; tasks/evidence-antfly-0.2.2.md).
 *
