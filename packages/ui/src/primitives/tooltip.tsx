...
const tooltipClasses = [
  'z-50 inline-flex w-fit max-w-(--available-width) origin-(--transform-origin) items-center gap-bakin-2 rounded-bakin-control',
...
export function TooltipContent({
  ...
  return (
    <TooltipPortal {...portalProps}>
      <TooltipPrimitive.Positioner align={align} alignOffset={alignOffset} side={side} sideOffset={sideOffset} collisionAvoidance={collisionAvoidance} className={`${anchoredPositionerClasses} max-w-xs`}>
