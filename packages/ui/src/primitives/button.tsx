  ...
  ],
  {
    variants: {
      ...
      size: {
        ...
        'icon-xs': 'size-bakin-6 [&_svg:not([class*="size-"])]:size-bakin-3',
        'icon-sm': 'size-bakin-8',
        'icon-md': 'size-[var(--bakin-layout-size-control)]',
        'icon-lg': 'size-[calc(var(--bakin-layout-size-control)+var(--bakin-layout-space-1))]',
      },
    },
    defaultVariants: {
      variant: 'primary',
