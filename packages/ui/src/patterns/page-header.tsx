  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="grid min-w-0 gap-bakin-3 @md/page-header:grid-cols-[minmax(0,1fr)_auto]"
      >
        {eyebrow ? (
          <p
        ...
        <div
          ...
          className="grid min-w-0 max-w-3xl gap-bakin-2 @md/page-header:col-start-1"
        >
          <h1
        ...
        {meta ? (
          <div
            ...
            className="flex min-w-0 flex-wrap items-center gap-x-bakin-3 gap-y-bakin-2 [overflow-wrap:anywhere] text-[length:var(--bakin-typography-size-meta)] text-bakin-text-muted @md/page-header:col-start-1"
          >
            {meta}
          </div>
        ) : null}
        ...
        {actions ? (
          <div
            ...
            className="flex w-full min-w-0 flex-col flex-wrap items-stretch gap-bakin-2 @sm/page-header:w-auto @sm/page-header:flex-row @sm/page-header:items-center @md/page-header:col-start-2 @md/page-header:row-start-1 @md/page-header:ml-auto @md/page-header:self-start [&>[data-slot=button]]:w-full @sm/page-header:[&>[data-slot=button]]:w-auto"
          >
            {actions}
          </div>
        ) : null}
