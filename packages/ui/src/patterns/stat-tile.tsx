  ...
  return (
    <Component
      ...
      className={cn(
        ...
        onClick && 'cursor-pointer outline-none transition-[background-color,border-color] duration-[var(--bakin-motion-duration-feedback)] ease-bakin-standard hover:border-bakin-action-primary-background/60 hover:bg-bakin-canvas-default/50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-bakin-focus-ring',
        className,
      )}
    >
