---
title: Contribute
description: Find the current contribution paths for Bakin plugins, agent kits, core changes, and docs quality.
---

Bakin contribution guidance now lives in Extending, next to the surfaces people actually build.
...
This page stays as a landing spot for older links. The maintained contribution material is in Extending.
