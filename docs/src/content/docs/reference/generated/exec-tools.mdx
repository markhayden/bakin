...
<McpToolCard id="messaging-session-materialize" name="bakin_exec_messaging_session_materialize" label="Materialized brainstorm proposals" description="Materialize approved Plan proposals into Plans" source="bakin-bits-official/plugins/messaging/index.ts:1865" parameters={[{"name":"sessionId","type":"string","required":true,"description":"Session ID (required)"}]}>
```sh frame="terminal"
