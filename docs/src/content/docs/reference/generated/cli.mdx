...
<CliCommandCard id="packages-list" name="packages list" summary="List packages." description="Lists installed packages.">
```sh frame="terminal"
bakin packages list
```
</CliCommandCard>
...
<div class="cli-command-list">
<CliCommandCard id="agents-list" name="agents list" summary="List agents." description="Lists runtime agents, or package state when `--packages` is set.">
```sh frame="terminal"
...
<div class="cli-command-list">
<CliCommandCard id="plugins-list" name="plugins list" summary="List installed plugins." description="Lists installed plugins and versions. Pass --check to probe remote/source for available upgrades.">
```sh frame="terminal"
