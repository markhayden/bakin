...
<CliCommandCard id="agents-update" name="agents update" summary="Update agent packages." description="Updates one or all installed agent packages.">
```sh frame="terminal"
...
<CliCommandCard id="packages-update" name="packages update" summary="Update a package." description="Updates an installed package.">
```sh frame="terminal"
...
<CliCommandCard id="agent-rules" name="agent-rules" summary="Manage AGENTS.md context." description="Applies or checks Bakin-managed AGENTS.md context sections.">
```sh frame="terminal"
