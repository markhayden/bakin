...
<div class="cli-command-list">
<CliCommandCard id="doctor" name="doctor" summary="Run health checks." description="Runs Bakin diagnostics for local dependencies, server state, agents, plugin assets, runtime behavior, and recoverable issues.">
```sh frame="terminal"
bakin doctor
```
</CliCommandCard>
...
<CliCommandCard id="install" name="install" summary="Install onboarding components." description="Installs Bakin dependencies, plugin/agent assets, or official recommended plugins.">
```sh frame="terminal"
...
<CliCommandCard id="onboard" name="onboard" summary="Run first-time onboarding." description="Runs the full first-run setup flow.">
```sh frame="terminal"
...
<CliCommandCard id="setup-service" name="setup service" summary="Install or remove macOS service integration." description="Installs or removes the LaunchAgent used for auto-start behavior on macOS.">
```sh frame="terminal"
