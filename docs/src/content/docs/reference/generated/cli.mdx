...
<CliCommandCard id="paths" name="paths" summary="Show content directory paths." description="Prints Bakin runtime paths, optionally for one key.">
```sh frame="terminal"
bakin paths [key]
```
  <table class="cli-command__args">
...
<div class="cli-command-list">
<CliCommandCard id="mkdir" name="mkdir" summary="Create the Bakin home directory tree." description="Creates or verifies the `~/.bakin` directory tree.">
```sh frame="terminal"
bakin mkdir
```
</CliCommandCard>
...
<div class="cli-command-list">
<CliCommandCard id="settings-get" name="settings get" summary="Read settings." description="Reads all settings or one dot-notation key.">
```sh frame="terminal"
...
<CliCommandCard id="settings-set" name="settings set" summary="Update a setting." description="Updates one setting using dot notation.">
```sh frame="terminal"
...
<CliCommandCard id="settings-init" name="settings init" summary="Seed default settings." description="Creates default settings if missing.">
```sh frame="terminal"
bakin settings init
```
</CliCommandCard>
