...
<CliCommandCard id="agents-knowledge" name="agents knowledge" summary="Manage agent knowledge toggles." description="Lists or toggles lesson/knowledge blocks for an agent package.">
```sh frame="terminal"
