...
<div class="cli-command-list">
<CliCommandCard id="plugins-list" name="plugins list" summary="List installed plugins." description="Lists installed plugins and versions. Pass --check to probe remote/source for available upgrades, or --json for raw API output.">
```sh frame="terminal"
...
<CliCommandCard id="plugins-upgrade" name="plugins upgrade" summary="Upgrade a user plugin." description="Re-pulls a user plugin from its source and rebuilds. --yes skips the consent prompt. Pass --json for raw API output.">
```sh frame="terminal"
