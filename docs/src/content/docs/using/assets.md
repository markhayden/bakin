...
The default recovery window is 7 days, configurable in Settings. Past that window the file stays there until you empty the trash. There's no auto-purge currently. Restore drops the file back at its canonical path, sidecar and all, and re-indexes.
