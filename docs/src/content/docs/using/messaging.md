...
<figure class="screenshot-frame">
  <img src="/docs/media/screenshots/using-messaging--calendar.png" alt="The content calendar with status, agent, content type, channel, and search filters above." loading="lazy">
</figure>
...
<figure class="screenshot-frame">
  <img src="/docs/media/screenshots/using-messaging--plan-workspace.png" alt="A Plan workspace with timeline, tasks, brainstorm context, and content-piece review." loading="lazy">
</figure>
...
<figure class="screenshot-frame">
  <img src="/docs/media/screenshots/using-messaging--brainstorm.png" alt="A brainstorm session with chat and Plan proposal review." loading="lazy">
</figure>
